<?php
	...
	function find_all_subjects($public = true){
		...
		$subject_set = mysqli_query($koneksi, $sql);
	...
	function find_pages_for_subject($subject_id, $public = true){
		...
		$sql="SELECT * FROM page
			WHERE subject_id = {$safe_subject_id}";
		if($public){
			$sql .= " AND visible = 1";
		}	
		$sql .= " ORDER BY position ASC";
		$page_set = mysqli_query($koneksi, $sql);
	...
	function find_default_page_by_subject($subject_id){
	...
	function find_selected_page($public = false){
		...
		if($current_subject && $public){
			$current_page =find_default_page_by_subject($current_subject["id"]);		
		} else{
			$current_page = null;
		}
	}
	...
	// function navigation perlu 2 parameter
